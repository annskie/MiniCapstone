...
<div>
    <strong><h1 class="text-center text-white">Edit Post</h1></strong>
    <div class="card offset-4 border-light" id="post-create"> <br>
    ...
    @endif
        ...
        <div class="card-body bg-secondary bg-opacity-75">
            ...
            @error('remarks')
                <p class="text-danger text-center">{{ $message }}</p>
            @enderror
        <button class="btn btn-primary btn-sm" wire:click="editRecentPost()">Update</button>
        <button class="btn btn-danger btn-sm" wire:click="back2()">
            Cancel
        </button>
    </div>
</div>
